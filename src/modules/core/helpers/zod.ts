...
export const stringField = (
  min?: number,
  max?: number,
  requiredMessage: string = "Поле обязательно к заполнению",
  minMessage: string = "Минимальная длина ${min}",
  maxMessage: string = "Максимальная длина ${max}"
) => {
...
export const emailField = (
  requiredMessage: string = "Поле обязательно к заполнению",
  emailMessage: string = "Некорректный формат почты"
) => {
...
export const phoneField = (
  requiredMessage: string = "Поле обязательно к заполнению",
  phoneMessage: string = "Некорректный формат номера телефона"
) => {
  return z
